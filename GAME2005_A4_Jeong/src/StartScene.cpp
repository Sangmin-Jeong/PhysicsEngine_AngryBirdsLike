...
void StartScene::Start()
{
	...
	m_pStartLabel = new Label("Sangmin Jeong(101369732)", "Consolas", 50, blue, glm::vec2(400.0f, 40.0f));
	m_pStartLabel->SetParent(this);
	AddChild(m_pStartLabel);

	//m_pInstructionsLabel = new Label("Sangmin Jeong(101369732)", "Consolas", 50, blue, glm::vec2(400.0f, 120.0f));
